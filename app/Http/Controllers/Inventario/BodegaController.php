...
class BodegaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        self::$transaccion = ['', 69, '', 'inv_bodega'];
    }
     ...
     *       2. Bodega::ConsultarPorEmpTipIdeNomApe.
     *       3. Bodega::find.
    ...
    public function CrearActualizar(Request $request)
    {
        ...
        if (!$id) {
            $existeRegistro = Bodega::ConsultarPorNombreDireccion(
                $request,
                $idEmpresa,
                $request->get('nombre'),
        ...
        if (!is_null($existeRegistro)) {
            ...
            elseif ($id || $existeRegistro->count() && $existeRegistro[0]->estado < 0) {
                ...
                $clase = $this->insertarCampos(Bodega::find($existeRegistro[0]->id), $request);
            ...
            #3.3. Si no existe entonces se crea
                ...
                $clase = $this->insertarCampos(new Bodega(), $request);
    ...
    public function CambiarEstado(Request $request) {
        ...
        $clase  = Bodega::Find((int)$request->get('id'));

...
class PrestamoDetallePagoController extends Controller
{
     ...
     * @version 1.0
     * @date_create 2018-04-01 - 11:51 AM
     * @see 1. PrestamoDetallePago::ConsultarTodoPorPrestamoDetalle.
     *      2. self::$hs->jsonError.
     *
     ...
     * @return object
     */
    public function Consultar($idEmpresa = null, $idPrestamoDetalle = null) {
        ...
        $objeto = PrestamoDetallePago::ConsultarTodoPorPrestamoDetalle(
            request()->get('buscador'),
            request()->get('pagina'),
            request()->get('tamanhio'),
            $idEmpresa,
            is_null($idPrestamoDetalle) ? request()->get('id_prestamo_detalle') : $idPrestamoDetalle
        );

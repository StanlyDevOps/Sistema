...
class Prestamo extends Model
{
     ...
     * @return object
     */
    public static function ActualizarDatosFinacieros($request, $idsPrestamo = array(), $sistema = false, $fechaPago = null, $idEstadoPago = null, $observacion = null) {
        ...
        try {
            ...
            foreach ($listaPrestamo as $item) {
                ...
                !is_null($observacion) ? $prestamo->observacion .= "\n$observacion" : '';

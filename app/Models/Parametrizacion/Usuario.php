...
class Usuario extends Model
{
    ...
    public function rol() {
        return $this->belongsTo(Rol::class, 'id_municipio');
    }
    public function sexo() {
        return $this->belongsTo(Sexo::class, 'id_sexo');
    }
    public function tipoDashboard() {
        return $this->belongsTo(TipoDashboard::class, 'id_tipo_dashboard_usuario');
    }

    #Has many
    public function preSeg() {
        return $this->hasMany(UsuarioPreguntasSeguridad::class, 'id_usuario');
    }

...
class Empresa extends Model
{
    ...
    public function emails() {
        return $this->hasMany(EmpresaEmails::class, 'id_empresa');
    }
    public function valores() {
        return $this->hasMany(EmpresaValores::class, 'id_empresa');
    }
    public function graficas() {
        return $this->hasMany(GraficasEmpresa::class, 'id_empresa');
    }
    public function tipoIdentificaciones() {
        return $this->hasMany(TipoIdentificacion::class, 'id_empresa');
    }
    public function bancos() {
        return $this->hasMany(Banco::class, 'id_empresa');
    }
    public function modEmp() {
        return $this->hasMany(ModuloEmpresa::class, 'id_empresa');
    }

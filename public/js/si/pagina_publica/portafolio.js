...
function listado(pagina,tamanhio,buscador) {
    ...
    var ruta        = 'imagenes/portafolio/';

    _ajaxBloques(controlador,enlace,'bloque',opciones,informacion,paginacion,ruta,4);
}
...
function guardar(actualizar,id) {
    ...
    var data = controlador.toLowerCase() + '?' +_urlCrud((actualizar ? 'Actualizar' : 'Guardar'),controlador)+'&id='+id+'&id_tipo_imagen='+$('#tipo_imagen').val();

...
Api.Codeudor = {
    ...
    buscar: function(id, $informacion) {

        $('#cliente-tabla-buscador #buscador').val($informacion.cedula);

        Api.Cliente.tabla();

        $('#modal-codeudor').modal('hide');

        setTimeout(function(){
            $('#cliente-tabla-buscador #buscador').val('');
        },1000);
    },
            ...
            parametrizacion: [
                {
                    nombre: 'Buscar',
                    icono: 'fa-search',
                    accion: 'Api.' + this.controlador + '.buscar',
                    color: '#555',
                    estado: false,
                    permiso: false,
                    informacion: true

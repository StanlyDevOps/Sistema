...
@section('script')
    <script type="text/javascript" src="{{asset('js/si/prestamo/cliente.js?v1.0')}}"></script>
    <script type="text/javascript" src="{{asset('js/si/prestamo/codeudor.js?v1.0')}}"></script>

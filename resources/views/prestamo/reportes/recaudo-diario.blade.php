...
<div id="content">
    ...
    <table class="table table-bordered table-hover table-striped tablesorter" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            @foreach($tabla as $r)
                <tr>
                    ...
                    <td align="center">{{$r->creado_por}}</td>
                    <td align="center">{{$r->fecha_abonado}}</td>
                    <td align="center">{{$r->cuotas_faltantes}}</td>
                    ...
                    <td align="center">${{number_format($r->abonado)}}</td>
                </tr>
        ...
        <tr>
            ...
            <td align="center">${{number_format($totalAbonado)}}</td>
        </tr>
        </tbody>
    </table>
    @else

                                        ...
                                        <div class="row">
                                            ...
                                            <form id="formulario-empresa">
                                                ...
                                                <div class="col-lg-6 form-group pad-t-22" id="ca-botones-empresa">
                                                    <?php if($op->guardar && $id_empresa === 1): ?>
                            ...
                            <div class="tabs-left">
                                ...
                                <div class="tab-content">
                                    <div id="detalle-general" class="tab-pane active">
                                        <?php echo $__env->make('parametrizacion.company.details', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                    <div id="modulos-sesiones" class="tab-pane">
                                        <div class="panel-body">
                                            <?php echo $__env->make('parametrizacion.company.modules-sessions', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        </div>
                                    </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript" src="<?php echo e(asset('js/si/parametrizacion/empresa.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/parametrizacion/modulo-empresa.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/parametrizacion/rol.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/parametrizacion/usuario.js')); ?>"></script>
    ...
    <script>
        ...
        Api.ie = parseInt('<?php echo e($id_empresa); ?>');

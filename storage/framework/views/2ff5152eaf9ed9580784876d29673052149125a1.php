...
<header>
    ...
    <br>
    <div class="texto">
        <strong>Fecha:</strong> <?php echo e($fecha); ?>.
        &nbsp;&nbsp;&nbsp;
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $tabla; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($r->nombres . ' ' . $r->apellidos); ?></td>
                    ...
                    <td align="center"><?php echo e($r->fecha_abonado); ?></td>
                    <td align="center"><?php echo e($r->cuotas_faltantes); ?></td>

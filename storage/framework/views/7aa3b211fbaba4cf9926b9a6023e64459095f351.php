                        ...
                        <div id="pestanhia-bodega" class="tabs-container">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="crear-editar" class="tab-pane">
                                    <div class="panel-body">
                                        <?php echo $__env->make('inventario.wineries.create-edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                </div>
                                <div id="detalle" class="tab-pane">
                                    <div class="panel-body ">
                                        <?php echo $__env->make('inventario.wineries.detail', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript" src="<?php echo e(asset('js/si/inventario/bodega.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/inventario/locacion.js')); ?>"></script>

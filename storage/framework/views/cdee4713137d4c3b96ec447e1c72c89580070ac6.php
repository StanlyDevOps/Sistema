        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
			    ...
			    <ul class="nav navbar-nav navbar-right">
                    <li <?php if($nombre == 'inicio'): ?> class="active" <?php endif; ?>><a href="inicio">Inicio</a></li>
                    <li <?php if($nombre == 'nosotros'): ?> class="active" <?php endif; ?>><a href="nosotros">Nosotros</a></li>
                    <li <?php if($nombre == 'servicios'): ?> class="active" <?php endif; ?>><a href="servicios">Servicios</a></li>
                    <li <?php if($nombre == 'portafolio'): ?> class="active" <?php endif; ?>><a href="portafolio">Portafolio</a></li>
                    ...
                    <li <?php if($nombre == 'contacto'): ?> class="active" <?php endif; ?>><a href="contacto">Contacto</a></li>
                </ul>
            </div>
        </div>
    </header><!--/header-->

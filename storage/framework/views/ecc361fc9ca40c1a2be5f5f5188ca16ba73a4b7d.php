                ...
                <div class="modal-body blanco-oscuro">
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" id="refinanciar-fecha-inicial" class="form-control m-b datepicker" value="<?php echo e(date('Y-m-d')); ?>" maxlength="10">
                                <span class="input-group-addon icono-calendario"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript" src="<?php echo e(asset('js/si/prestamo/calculos.js?v1.0')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/prestamo/prestamo.js?v1.0')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/prestamo/prestamo-detalle.js?v1.0')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/prestamo/prestamo-detalle-pago.js?v1.0')); ?>"></script>

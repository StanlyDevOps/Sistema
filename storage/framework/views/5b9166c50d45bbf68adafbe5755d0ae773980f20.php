    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide wet-asphalt">
            ...
            <div class="carousel-inner">
                <div class="item active" style="background-image: url(<?php echo e(asset('temas/stids/img/slider/bg1.jpg')); ?>">
                    <div class="container">
                        <div class="row">
                             <div class="col-sm-6">
                ...
                <div class="item" style="background-image: url(<?php echo e(asset('temas/stids/img/slider/bg2.jpg')); ?>">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                ...
                <div class="item" style="background-image: url(<?php echo e(asset('temas/stids/img/slider/bg3.jpg')); ?>">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content center centered">
    ...
    <section id="services" class="emerald">
        <div class="container">
            ...
            <center> <h3 style="color: #1f9b83;" class="media-heading">DISEÑAMOS Y DESARROLLAMOS<br>
                ...
                <center><img class="img-responsive" src="<?php echo e(asset('temas/stids/img/que_hacemos.png')); ?>" width="250" alt=""></center> 
                            ...
                            <div class="item active">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/html5.png')); ?>" alt="">
                                                <h5>
                                                   <center> HTML5 </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/html5.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/php7.png')); ?>" alt="">
                                                <h5>
                                                    <center> PHP7 </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/php7.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/javascript.png')); ?>" alt="">
                                                <h5>
                                                    <center> JAVASCRIPT </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/javascript.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/jquery.png')); ?>" alt="">
                                                <h5>
                                                    <center> JQUERY </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/jquery.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                      ...
                                      <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/css3.png')); ?>" alt="">
                                                <h5>
                                                   <center> CSS3 </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/css3.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                           
                                      ...
                                      <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/photoshop.png')); ?>" alt="">
                                                <h5>
                                                    <center> PHOTOSHOP </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/photoshop.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/mysql.png')); ?>" alt="">
                                                <h5>
                                                    <center> MYSQL </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/mysql.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                        ...
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo e(asset('temas/stids/img/herramientas/laravel.png')); ?>" alt="">
                                                <h5>
                                                    <center> LARAVEL </center>
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="" href="<?php echo e(asset('temas/stids/img/herramientas/laravel.png')); ?>" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<img src="<?php echo e(asset('temas/stids/img/servicios/desarrolloweb.png')); ?>" width="200px">
...
<img src="<?php echo e(asset('temas/stids/img/servicios/base.png')); ?>" width="200px">
...
<img src="<?php echo e(asset('temas/stids/img/servicios/responsivo.png')); ?>" width="200px">
...
<div class="col-md-4 ">
<div class="service_block pv-30 ph-20 service-block bordered shadow text-center object-non-visible animated object-visible fadeInDownSmall" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
<img src="<?php echo e(asset('temas/stids/img/servicios/posisionamiento.png')); ?>" width="200px">
...
<div class="col-md-4 ">
<div class="service_block pv-30 ph-20 service-block bordered shadow text-center object-non-visible animated object-visible fadeInDownSmall" data-animation-effect="fadeInDownSmall" data-effect-delay="150">
<img src="<?php echo e(asset('temas/stids/img/servicios/redes.png')); ?>" width="200px">
...
<div class="col-md-4 ">
<div class="service_block pv-30 ph-20 service-block bordered shadow text-center object-non-visible animated object-visible fadeInDownSmall" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
<img src="<?php echo e(asset('temas/stids/img/servicios/seguridad.png')); ?>" width="200px">
...
<div class="row ">
    ...
    <img src="<?php echo e(asset('temas/stids/img/clientes/vytech.png')); ?>" width="200px">
    </div>
    </div>
    <div class="col-md-3 ">
    <div class="" data-animation-effect="fadeInDownSmall" data-effect-delay="150">
    <img src="<?php echo e(asset('temas/stids/img/clientes/conipal.png')); ?>" width="200px">
    </div>
    </div>
    <div class="col-md-3 ">
    <div class="" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
    <img src="<?php echo e(asset('temas/stids/img/clientes/thermecs.png')); ?>" width="200px">
    </div>
    </div>
    <div class="col-md-3 ">
    <div class="" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
    <img src="<?php echo e(asset('temas/stids/img/clientes/plazabolivar.png')); ?>" width="200px">
    </div>
    </div>
    </marquee>

                ...
                <div class="wrapper wrapper-content">
                    <div class="row">
                        <div class="col-lg-6" id="impuesto">
                            <?php echo $__env->make('inventario.configuration.tax', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <div class="col-lg-6" id="unidades">
                            <?php echo $__env->make('inventario.configuration.unity', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>

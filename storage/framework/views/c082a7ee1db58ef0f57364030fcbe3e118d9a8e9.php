                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12" align="center">
                                    <div class="btn-group">
                                        <button id="btn-modulo" class="btn btn-white" onclick="Api.Dashboard.mostrarContenedor(1)" <?php if(!$op->actualizar): ?> disabled <?php endif; ?>>
                                            <i class="fa fa-list-alt"></i>
                                            Módulos
                                        </button>
                                        <button id="btn-grafica" class="btn btn-white" onclick="Api.Dashboard.mostrarContenedor(2)" <?php if(!$op->actualizar): ?> disabled <?php endif; ?>>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript" src="<?php echo e(asset('js/si/perfil/perfil.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/perfil/seguridad.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/si/perfil/dashboard.js')); ?>"></script>
    <script>

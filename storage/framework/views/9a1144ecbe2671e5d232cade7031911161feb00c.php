...
<?php $__env->startSection('content'); ?>
			...
			<div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
					...
					<div class="panel-heading" align="center">
						...
						<a href="ingresar">
							...
							<img src="temas/<?php echo e($empresa['tema_nombre']); ?>/img/logo-stids.png" alt="Logo Stids" width="320px">
	...
	<input type="hidden" id="rutaImagen" value="<?php echo e($empresa['tema_nombre']); ?>">
	...
	<script type="text/javascript" src="<?php echo e(asset('js/ingresar.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('temas.'.$empresa['nombre_logueo'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
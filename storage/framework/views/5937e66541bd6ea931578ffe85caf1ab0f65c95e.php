...
<?php $__env->startSection('script'); ?>
    ...
    <?php if($pg): ?>
        <script type="text/javascript" src="<?php echo e(asset('js/si/graficas/parametrizacion.js')); ?>"></script>
    <?php endif; ?>

    <script>
        Api.permisos = [<?php echo e($permisos); ?>];
        Api.Graficas.permisos = [<?php echo e($permisosGraficas); ?>];
        Api.Usuario.ie = parseInt('<?php echo e($id_empresa); ?>');
        Api.Usuario.constructor('crear-editar #mensaje',[<?php echo e($permisosGraficas); ?>]);
    </script>
<?php $__env->stopSection(); ?>
